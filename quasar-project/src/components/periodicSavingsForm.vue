...
const _savingP = ref({ account: bank.value.accounts[0].title, amount: 100.0, startMonth: 0, startYear: 0, endMonth: 0, endYear: 0, type: BANK_SAVE_TYPE_MONTHLY, startingDate: '', endDate: '' });
